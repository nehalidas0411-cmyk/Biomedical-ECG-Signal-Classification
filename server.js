...
app.post('/api/classify', (req, res) => {
  ...
  // Score each class using distance from known feature centroids
  const scores = [
    // Normal: ptp ~0.82, std ~0.13, skew ~-0.04, zc ~18
    1.5
      - Math.abs(f.ptp  - 0.82) * 1.2
      - Math.abs(f.std  - 0.13) * 2.0
      - Math.abs(f.skew + 0.04) * 0.3
      - Math.abs(f.zc   - 18)   * 0.02,

    // Supraventricular: ptp ~0.95, zc ~42, skew ~0.45
    1.0
      - Math.abs(f.ptp  - 0.95) * 1.0
      - Math.abs(f.zc   - 42)   * 0.02
      - Math.abs(f.skew - 0.45) * 0.4,

    // Ventricular: ptp ~2.2, std ~0.42, skew ~-1.2, zc ~12
    1.0
      - Math.abs(f.ptp  - 2.20) * 0.5
      - Math.abs(f.std  - 0.42) * 1.5
      - Math.abs(f.skew + 1.20) * 0.3
      - Math.abs(f.zc   - 12)   * 0.02,

    // Fusion: ptp ~1.4, kurt ~8.2, skew ~1.8
    1.0
      - Math.abs(f.ptp  - 1.40) * 0.8
      - Math.abs(f.kurt - 8.20) * 0.08
      - Math.abs(f.skew - 1.80) * 0.3,

    // Unknown: kurt ~15, ptp ~1.1, zc ~8
    1.0
      - Math.abs(f.kurt - 15.0) * 0.05
      - Math.abs(f.ptp  - 1.10) * 0.9
      - Math.abs(f.zc   - 8)    * 0.03,
  ];
